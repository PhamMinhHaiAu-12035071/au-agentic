...
> Auto-generated by `bun run perf` on 2026-04-17T16:08:04.214Z.
...
|---|---|---:|---:|---:|
| PASS | `biome format` | 65 | 200 | 500 |
| PASS | `biome lint` | 76 | 200 | 500 |
| PASS | `biome check (full)` | 82 | 300 | 800 |
| PASS | `secretlint staged-equivalent` | 427 | 2000 | 5000 |
| PASS | `ls-lint (full repo)` | 49 | 500 | 2000 |
| PASS | `bun test (single file)` | 115 | 300 | 1000 |
| PASS | `bun test (full sequential)` | 284 | 1000 | 3000 |
| PASS | `bun test (full concurrent)` | 251 | 500 | 1500 |
| PASS | `bun test (cursor-agent-bench unit)` | 155 | 200 | 500 |
| PASS | `bun typecheck (warm)` | 261 | 1000 | 3000 |
| PASS | `turbo test (cache hit)` | 242 | 300 | 1000 |
| PASS | `turbo verify (cache hit)` | 250 | 1000 | 3000 |
| PASS | `turbo verify (cold)` | 1367 | 10000 | 30000 |
| PASS | `knip` | 533 | 3000 | 8000 |
| PASS | `markdownlint` | 838 | 2000 | 5000 |
| PASS | `worktree W1: bun run setup (cache hit from main)` | 87 | 500 | 2000 |
| PASS | `worktree W2: turbo verify (cache hit from main)` | 743 | 2000 | 5000 |
| PASS | `worktree W3: full subagent loop (install+verify)` | 818 | 3000 | 8000 |
| PASS | `worktree cold: create+install+verify+remove` | 3093 | 5000 | 15000 |
