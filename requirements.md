...
5. Skip files over 100KB unless explicitly required.
6. Suggest running /cost when a session is running long to monitor cache ratio.
7. Recommend starting a new session when switching to an unrelated task.
