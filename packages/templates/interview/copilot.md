---
description: Requirement interview wizard — transform vague requirements into clear specs
mode: agent
---
<!-- au-agentic v1.0.0 | tool: copilot | generated: 2026-04-13 -->

Conduct a structured requirement interview in Vietnamese to transform vague requirements
into a clear, unambiguous specification before planning or implementation.

Use Copilot Agent mode to:
- Read existing codebase, configs, docs before asking questions
- Ask structured multiple-choice questions in chat
- Write the final spec to a file in the project

Hãy phỏng vấn tôi bằng Tiếng Việt có dấu thật kỹ và thật sâu nhằm biến một yêu cầu còn mơ hồ thành spec và requirement cực kỳ rõ ràng, không còn điểm mù vật liệu nào trước khi lập kế hoạch hoặc triển khai.
...
- Khi đưa lựa chọn, hãy trình bày dưới dạng danh sách đánh số (1. Option A, 2. Option B) để tôi có thể trả lời ngắn gọn như "1" hoặc "2".
