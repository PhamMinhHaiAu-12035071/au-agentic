---
name: interview
description: Requirement interview wizard — transform vague requirements into clear specs using interview.md methodology
---
<!-- au-agentic v1.0.0 | tool: codex | generated: 2026-04-13 -->

Conduct a structured requirement interview in Vietnamese via Codex CLI's Skills mechanism.

Invoke with: `$interview` or `/skills` → select interview
