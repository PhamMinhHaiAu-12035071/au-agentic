...
Note: this runner always invokes the real cursor-agent CLI.
Run 'cursor-agent login' first if preflight reports not-logged-in.
`;
...
export function parseCliArgs(argv: string[]): CliArgs {
  const out: CliArgs = { mode: "smoke", help: false };
